...
SampleMirror::SampleMirror(_pii arenaDimension, _pii collectibles, _pii startPos,
...
SampleMirror::~SampleMirror() {
}

int SampleMirror::getNextMove(vector<string> surroundings) {
